const staticCacheName = "Instablam-site-static-v2.2.8";
const assetsArr = ['/index.html', '/assets/icons/logoInstaBlam192.png', '/assets/icons/logoInstaBlam512.png', '/assets/main.css', '/assets/icons/favicon.ico', '/manifest.json', ];
//install event
